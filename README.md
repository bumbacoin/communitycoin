...
version 1.5.0 hit a snag with the one year block being unable to stake beyond it.
this is a short term fix . it is able to stake, but unable to sync (however 1.5.0 syncs fine so juggling the two codes is a workaround)

see https://github.com/bumbacoin/CommunityCoin1.5.1
for an actual fix.
===
